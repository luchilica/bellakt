  ...
  return (
    <div id="settings-container" className="w-full max-w-xl sm:max-w-2xl lg:max-w-none mx-auto space-y-5 sm:space-y-6 pb-12">
      ...
      <Tabs value={activeTab} onValueChange={(val) => setActiveTab(val as any)} className="w-full">
        <TabsList className="grid w-full grid-cols-4 p-1.5 bg-slate-100 dark:bg-slate-800/80 border border-slate-200/80 dark:border-slate-700/80 rounded-2xl shadow-2xs h-13 sm:h-14 gap-1">
          <TabsTrigger
            value="appearance"
            className="rounded-xl font-bold text-xs sm:text-sm data-active:bg-white dark:data-active:bg-slate-900 data-[state=active]:bg-white dark:data-[state=active]:bg-slate-900 data-active:text-[#002B7F] dark:data-active:text-blue-300 data-[state=active]:text-[#002B7F] dark:data-[state=active]:text-blue-300 data-active:shadow-xs data-[state=active]:shadow-xs text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-200 flex items-center justify-center gap-1.5 transition-all"
          >
        ...
        <TabsContent value="appearance" className="mt-5 space-y-4">
          <div className="bg-white dark:bg-slate-900 rounded-2xl sm:rounded-3xl border border-slate-200 dark:border-slate-800 shadow-2xs p-5 sm:p-6">
            <ThemeSettingsCard />
          </div>
        </TabsContent>
        ...
        <TabsContent value="navigation" className="mt-5 space-y-5">
          {/* Live Preview Card */}
          <div className="rounded-2xl sm:rounded-3xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-5 sm:p-6 shadow-2xs space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Button
                ...
                className="rounded-xl text-xs font-bold h-8 px-3 border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white cursor-pointer"
              >
            ...
            <div className="bg-slate-50 dark:bg-slate-800/60 rounded-2xl p-2.5 sm:p-3 border border-slate-200/80 dark:border-slate-700/80 shadow-xs flex items-center justify-between gap-1.5 sm:gap-2">
              ...
              <div className="flex items-center gap-1.5 px-3 py-2 rounded-xl bg-[#E8F1FC] dark:bg-blue-950/60 text-[#002B7F] dark:text-blue-300 text-xs font-bold border border-blue-200/80 dark:border-blue-900/50 truncate">
                {renderNavIcon(item1.iconName, 'w-4 h-4 stroke-[2.2px] shrink-0 text-[#002B7F] dark:text-blue-300')}
                <span className="truncate">{item1.label}</span>
              </div>

              {/* Slot 2 dynamic */}
              <div className="flex items-center gap-1.5 px-3 py-2 rounded-xl bg-[#E8F1FC] dark:bg-blue-950/60 text-[#002B7F] dark:text-blue-300 text-xs font-bold border border-blue-200/80 dark:border-blue-900/50 truncate">
                {renderNavIcon(item2.iconName, 'w-4 h-4 stroke-[2.2px] shrink-0 text-[#002B7F] dark:text-blue-300')}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
            {/* Slot 1 Chooser */}
            <div className="rounded-2xl sm:rounded-3xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-5 sm:p-6 shadow-2xs space-y-3.5">
              <div>
        ...
        <TabsContent value="kiosk" className="mt-5 space-y-4">
          <div className="rounded-2xl sm:rounded-3xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-5 sm:p-6 shadow-2xs space-y-5">
